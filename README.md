...
![Wireframe 1](<attachments/Pasted image 20260506160236.png>)

2. Экран заполнения чек-листа (Да/Нет/Н/А, прогресс).  
![Wireframe 2](<attachments/Pasted image 20260506160250.png>)

3. Фотофиксация нарушения (камера внутри приложения).  
![Wireframe 3](<attachments/Pasted image 20260506160300.png>)

4. Подтверждение отправки отчета и статус проверки.  
![Wireframe 4](<attachments/Pasted image 20260506160309.png>)
